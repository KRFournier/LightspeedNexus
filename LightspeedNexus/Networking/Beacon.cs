...
{
    internal const int DiscoveryPort = 22750;
...
#pragma warning restore CA1416
    ...
    internal static bool HasPrefix<T>(IEnumerable<T> haystack, IEnumerable<T> prefix) => haystack.Count() >= prefix.Count() &&
            haystack.Zip(prefix, (a, b) => ReferenceEquals(a, b)).All(_ => _);
